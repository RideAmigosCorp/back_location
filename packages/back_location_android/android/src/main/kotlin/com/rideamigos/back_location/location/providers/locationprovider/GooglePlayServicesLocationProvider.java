...
import com.rideamigos.back_location.location.providers.locationprovider.GooglePlayServicesLocationSource.SourceListener;
...
public class GooglePlayServicesLocationProvider extends LocationProvider implements SourceListener {
    ...
    private com.rideamigos.back_location.location.providers.locationprovider.GooglePlayServicesLocationSource googlePlayServicesLocationSource;
    ...
    // For test purposes
    void setDispatcherLocationSource(com.rideamigos.back_location.location.providers.locationprovider.GooglePlayServicesLocationSource googlePlayServicesLocationSource) {
        this.googlePlayServicesLocationSource = googlePlayServicesLocationSource;
    }

    private com.rideamigos.back_location.location.providers.locationprovider.GooglePlayServicesLocationSource getSourceProvider() {
        if (googlePlayServicesLocationSource == null) {
            googlePlayServicesLocationSource = new com.rideamigos.back_location.location.providers.locationprovider.GooglePlayServicesLocationSource(getContext(),
