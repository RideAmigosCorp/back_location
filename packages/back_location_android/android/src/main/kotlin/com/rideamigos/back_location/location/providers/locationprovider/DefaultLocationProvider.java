...
public class DefaultLocationProvider extends LocationProvider implements ContinuousTaskRunner, LocationListener {
    ...
    public void runScheduledTask(@NonNull String taskId) {
        if (taskId.equals(com.rideamigos.back_location.location.providers.locationprovider.DefaultLocationSource.PROVIDER_SWITCH_TASK)) {
            getSourceProvider().getUpdateRequest().release();
    ...
    // For test purposes
    public void setDefaultLocationSource(com.rideamigos.back_location.location.providers.locationprovider.DefaultLocationSource defaultLocationSource) {
        this.defaultLocationSource = defaultLocationSource;
    }

    private com.rideamigos.back_location.location.providers.locationprovider.DefaultLocationSource getSourceProvider() {
        if (defaultLocationSource == null) {
            defaultLocationSource = new com.rideamigos.back_location.location.providers.locationprovider.DefaultLocationSource(getContext(), this, this);
        }
