...
import com.rideamigos.back_location.location.listener.FallbackListener;
import com.rideamigos.back_location.location.providers.locationprovider.DispatcherLocationSource;
...
public class DispatcherLocationProvider extends com.rideamigos.back_location.location.providers.locationprovider.LocationProvider implements ContinuousTaskRunner, FallbackListener {

    private Dialog gpServicesDialog;
    private com.rideamigos.back_location.location.providers.locationprovider.LocationProvider activeProvider;
    private com.rideamigos.back_location.location.providers.locationprovider.DispatcherLocationSource dispatcherLocationSource;
    ...
    public void runScheduledTask(@NonNull String taskId) {
        if (taskId.equals(com.rideamigos.back_location.location.providers.locationprovider.DispatcherLocationSource.GOOGLE_PLAY_SERVICE_SWITCH_TASK)) {
    ...
    // For test purposes
    void setDispatcherLocationSource(com.rideamigos.back_location.location.providers.locationprovider.DispatcherLocationSource dispatcherLocationSource) {
        this.dispatcherLocationSource = dispatcherLocationSource;
    }

    private com.rideamigos.back_location.location.providers.locationprovider.DispatcherLocationSource getSourceProvider() {
        if (dispatcherLocationSource == null) {
            dispatcherLocationSource = new com.rideamigos.back_location.location.providers.locationprovider.DispatcherLocationSource(this);
        }
