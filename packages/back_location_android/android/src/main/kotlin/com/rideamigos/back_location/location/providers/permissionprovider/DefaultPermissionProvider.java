package com.rideamigos.back_location.location.providers.permissionprovider;
...
public class DefaultPermissionProvider extends PermissionProvider implements DialogListener {
    ...
    private com.rideamigos.back_location.location.providers.permissionprovider.PermissionCompatSource permissionCompatSource;
    ...
    // For test purposes
    void setPermissionCompatSource(com.rideamigos.back_location.location.providers.permissionprovider.PermissionCompatSource permissionCompatSource) {
        this.permissionCompatSource = permissionCompatSource;
    }

    protected com.rideamigos.back_location.location.providers.permissionprovider.PermissionCompatSource getPermissionCompatSource() {
        if (permissionCompatSource == null) {
            permissionCompatSource = new com.rideamigos.back_location.location.providers.permissionprovider.PermissionCompatSource();
        }
