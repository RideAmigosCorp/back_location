...
+ (instancetype)makeWithUseGooglePlayServices:(NSNumber *)useGooglePlayServices
...
+ (PigeonLocationSettings *)fromList:(NSArray *)list {
  PigeonLocationSettings *pigeonResult = [[PigeonLocationSettings alloc] init];
  pigeonResult.useGooglePlayServices = GetNullableObjectAtIndex(list, 0);
  NSAssert(pigeonResult.useGooglePlayServices != nil, @"");
  pigeonResult.fallbackToGPS = GetNullableObjectAtIndex(list, 1);
  NSAssert(pigeonResult.fallbackToGPS != nil, @"");
  pigeonResult.ignoreLastKnownPosition = GetNullableObjectAtIndex(list, 2);
  NSAssert(pigeonResult.ignoreLastKnownPosition != nil, @"");
  pigeonResult.expirationDuration = GetNullableObjectAtIndex(list, 3);
  pigeonResult.expirationTime = GetNullableObjectAtIndex(list, 4);
  pigeonResult.fastestInterval = GetNullableObjectAtIndex(list, 5);
  NSAssert(pigeonResult.fastestInterval != nil, @"");
  pigeonResult.interval = GetNullableObjectAtIndex(list, 6);
  NSAssert(pigeonResult.interval != nil, @"");
  pigeonResult.maxWaitTime = GetNullableObjectAtIndex(list, 7);
  pigeonResult.numUpdates = GetNullableObjectAtIndex(list, 8);
  pigeonResult.accuracy = [GetNullableObjectAtIndex(list, 9) integerValue];
  pigeonResult.smallestDisplacement = GetNullableObjectAtIndex(list, 10);
  NSAssert(pigeonResult.smallestDisplacement != nil, @"");
  pigeonResult.waitForAccurateLocation = GetNullableObjectAtIndex(list, 11);
  NSAssert(pigeonResult.waitForAccurateLocation != nil, @"");
  pigeonResult.acceptableAccuracy = GetNullableObjectAtIndex(list, 12);
  return pigeonResult;
}
+ (nullable PigeonLocationSettings *)nullableFromList:(NSArray *)list {
